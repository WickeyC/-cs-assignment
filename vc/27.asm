...
.DATA
    ...
    choice DB 0
    TQ_MSG DB 13,10,8 dup (32),30 dup (03)
           DB 13,10,8 dup (32),"Thank you for using the kiosk!"
           DB 13,10,8 dup (32),"Enter 1 to use it again or any other keys to terminate: $"
    ...
    invalidPasswordMsg2 DB 13,10,"            ~~~ Password must meet the following requirements ~~~"
    ...
    choosePmMsg DB 13,10,      "                   |/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/| "
                ...
                DB 13,10,13,10,"                   Enter your choice (1-3): $"
    ; <- CASH ->
    cashPayMsg      DB 13,10,          "                   Enter Pay Amount    : RM $"
    ...
    invalidCardNumDigitMsg DB       "                    <<< Sorry, invalid input! >>>"
                           DB 13,10,"                    - Card Must be Number Only! -$"
    ...
    ; # BOOLEAN
        ...
        hasOrder   DB 0
    ; * Stock
        stockArr DW 10,11,12,13,14,15,12,20,30,22
    ; * Quantity
...
MAIN PROC
    ...
    ; <<<<< CALCULATION MACROS >>>>>
        ;---Get Floating Point Input---
            ...
            GET_MAN_INPUT MACRO INP
                LOCAL InputNo,FormNo,ViewNo,Formtenths,Formhundreths,Mantissa_Error,DelNo,VALIDATE_TYPE,END
                MOV CX,0
                InputNo:
                    MOV AH,00H
                    INT 16H
    ...
    START:
        ...
        PRNSTR NL_1
        PRN_WHSP 19
        PRNSTR_COLOR choiceErrorMsg,54,4
        PRN_WHSP 19
        CALL PRESS_CONT
        CALL CLS
        JMP START
    ...
    SIGNUP:
        ...
        SUCCESS_SIGNUP:
            ...
            PRNSTR NL_1
            PRN_WHSP 32
            PRNSTR_COLOR signupSuccessMsg1,17,2
        ...
        INVALID_USERNAME:
            PRNSTR NL_2
            PRNSTR_COLOR invalidUsernameMsg1,56,4
            ...
            JE START
            PRN_WHSP 22
            PRNSTR_COLOR choiceErrorMsg,35,4
            PRN_WHSP 26
            CALL PRESS_CONT
            JMP INVALID_USERNAME
        INVALID_PSW:
            PRNSTR NL_2
            PRNSTR_COLOR invalidPasswordMsg1,56,4
    ...
    LOGIN:
        ...
        CORRECT_PSW:
            PRNSTR NL_1
            PRN_WHSP 20
            PRNSTR_COLOR correctPswMsg,39,2
            PRN_WHSP 25
            CALL PRESS_CONT
            CALL CLS
            JMP MAIN_MENU
        WRONG_LOGIN:
            PRNSTR NL_2
            PRNSTR_COLOR wrongLoginMsg1,58,4
    ...
    ICE_CREAM_MENU:
        ...
        INVALID_CURRQTY1_ERROR:
            CALL INVALID_CURRQTY1_ERROR_PROC
            JMP ICE_CREAM_MENU
        INVALID_CURRQTY2_ERROR:
            PRNSTR NL_1
            PRN_WHSP 5
            PRNSTR_COLOR invalidQuantity2Msg,70,4
            PRN_WHSP 24
            PRNSTR contMsg
            MOV AH,0
            INT 16H
    ...
    ORDER_PRICE_REVIEW:
        ...
        PRNSTR NL_1
        PRN_WHSP 14
        PRNSTR_COLOR orderRecordedSuccessMsg,45,2
        ;-----Navigate
        ...
        PRNSTR NL_1
        PRN_WHSP 19
        PRNSTR_COLOR selectionErrorMsg,39,4
        PRN_WHSP 25
        CALL PRESS_CONT
    ...
    REVIEW_MENU:
        ...
        MOV temp,7
        PRINT_ITEMS: ; [TODO] Simplify the code below
    ...
    RECEIPT_MENU:
        ...
        VOUCHER_YES:
            ...
            VALID_CODE:
                PRNSTR NL_2
                PRNSTR_COLOR voucherAppliedMsg,48,2
                JMP PRINT_RECEIPT_WITH_VOUCHER
            INVALID_CODE:
                PRNSTR NL_2
                PRNSTR_COLOR invalidVoucherMsg,35,4
                PRN_WHSP 19
                CALL PRESS_CONT
                JMP RECEIPT_MENU
    ...
    PAY_CASH:
        ...
        INSUFFICIENT_ERROR:
            PRNSTR NL_1
            PRNSTR_COLOR insufficientMsg,62,4
            MOV AH,0
            INT 16H
            JMP PAY_CASH
        PAYMENT_SUCCESS:
            ...
            PRN_WHSP 19
            PRNSTR_COLOR payChangeMsg,32,2
    ...
    PAY_CARD:
        ...
        GET_CARD_NUM_LOOP:
            ...
            INVALID_CARD_NUM_DIGIT:
                PRNSTR NL_1
                PRNSTR_COLOR invalidCardNumDigitMsg,49,4
                PRN_WHSP 20
                CALL PRESS_CONT
                JMP PAY_CARD
        ...
        VALID_CARD:
            PRNSTR NL_2
            PRNSTR_COLOR successPaymentMsg,68,2
            PRN_WHSP 20
            CALL PRESS_CONT
            JMP DINE_METHOD_and_REF_CODE
        ...
        INVALID_CARD:
            PRNSTR NL_2
            PRNSTR_COLOR invalidCardMsg,54,4
            PRN_WHSP 20
            CALL PRESS_CONT
            JMP PAY_CARD
    ;---------------------END OF SECTION#9-------------------------
    ...
    DINE_METHOD_and_REF_CODE:
        ...
        ;-----Get choice
            ...
            CMP CHOICE,"1"
            JNE CHK_EAT_IN
            PRNSTR_COLOR dineOutMsg,11,2
            JMP GENERATE_RAN_REF
            CHK_EAT_IN:
            CMP CHOICE,'2'
            JNE DINE_CHOICE_ERROR
            PRNSTR_COLOR eatInMsg,9,2
            JMP GENERATE_RAN_REF
            ;-----Choice Error
            DINE_CHOICE_ERROR:
                PRNSTR NL_1
...
; <<<<<<<<<<<< Procedures >>>>>>>>>>>>
    ...
    PRINT_STOCK PROC
        ...
        RET
    PRINT_STOCK ENDP
    INVALID_CURRQTY1_ERROR_PROC PROC
        PRNSTR NL_1
        PRN_WHSP 12
        PRNSTR_COLOR invalidQuantity1Msg,53,4
        PRN_WHSP 24
        PRNSTR contMsg
        MOV AH,0
        INT 16H
        RET
    INVALID_CURRQTY1_ERROR_PROC ENDP
    MAX_ERROR_PROC PROC
        PRNSTR NL_1
        PRN_WHSP 5
        PRNSTR_COLOR maxStockErrorMsg,70,4
        MOV AH,0
        INT 16H
        RET
    MAX_ERROR_PROC ENDP
